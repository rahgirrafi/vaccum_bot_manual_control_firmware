...
void micro_ros_init(void)
{
    ...
    std_msgs__msg__Int8__init(&keyboard_msg_group1);
    ...
    ESP_LOGI(TAG, "Initializing subscription to /keyboard/group1...");
    keyboard_sub_group1 = rcl_get_zero_initialized_subscription();
