...
{
    ESP_LOGI(TAG, "Starting ESP32 Keyboard Motor Control Node - Single Motor (Group 1)");
    ...
    ESP_LOGI(TAG, "Publishing AS5600 sensor data at 10 Hz on /as5600_sensors_right");
    ESP_LOGI(TAG, "Publishing encoder data at 10 Hz on /encoder_sensors_right");
