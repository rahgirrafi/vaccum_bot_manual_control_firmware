...
// TB6612FNG Motor Driver GPIO pins for Motor 2 (Group 2)
...
#define MOTOR3_PWM_GPIO    GPIO_NUM_27    // PWM signal  
#define MOTOR3_IN1_GPIO    GPIO_NUM_5     // Direction control 1
#define MOTOR3_IN2_GPIO    GPIO_NUM_15    // Direction control 2
#define MOTOR3_STBY_GPIO   GPIO_NUM_23    // Standby pin

// PWM Configuration for Motor 2
...
// PWM Configuration for Motor 3
#define MOTOR3_PWM_CHANNEL LEDC_CHANNEL_1
#define MOTOR3_PWM_TIMER   LEDC_TIMER_1
#define MOTOR3_PWM_FREQ    1000           // 1kHz PWM frequency
#define MOTOR3_PWM_DUTY    4095           // 12-bit resolution (0-4095)

// Motor control variables
extern int8_t motor2_command;
extern int8_t motor3_command;
extern SemaphoreHandle_t motor_mutex;
extern TickType_t last_command_time_motor2;
extern TickType_t last_command_time_motor3;
